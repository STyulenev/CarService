...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/carservice/warehouse/update/*").hasRole("ADMIN")
                .antMatchers("/carservice/detail/get/*").permitAll()
                .antMatchers("/carservice/office/get/*").permitAll()
                .antMatchers("/carservice/warehouse/get/*").permitAll()
